...
episode = 0     # to track the episode count
...
class SingleStateHardwareVerifEnv(gym.Env):
    ...
    def __init__(self, num_action_params, num_events, reward_function,
        ...
        self.logger = logger
        self.chosen_actions = []    # stores the actions chosen by the agent over the episodes
    ...
    def step(self, action):
        ...
        global episode
        print('Taking RL step ' + str(episode))
        generator_probab = []
    ...
    def reset(self):
        ...
        global episode
        self.logger.info('RL | Episode ' + str(episode) + ' |dut reset asserted')
