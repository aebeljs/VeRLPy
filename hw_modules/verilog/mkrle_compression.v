...
//
// On Thu Jan 28 01:09:26 IST 2021
//
//
// Ports:
// Name                         I/O  size props
...
module mkrle_compression(CLK,
  ...
  reg [7 : 0] bs__h23661, temp__h24264;
  wire [63 : 0] x__h29077,
		y_avValue_snd_fst__h29067,
		y_avValue_snd_snd_fst__h29062,
		y_avValue_snd_snd_fst__h29063;
  wire [7 : 0] x__h24339, y__h24268;
  ...
  wire NOT_IF_rg_zero_counter_62_PLUS_0_CONCAT_rg_cou_ETC___d1063,
       ...
       _dfoo997,
       _dfoo999,
       ma_get_input_val_EQ_0_206_AND_NOT_rg_count_wid_ETC___d1232,
       rg_counter_209_EQ_IF_rg_count_width_70_EQ_1_20_ETC___d1224,
  ...
  assign i__h14561 = temp_word_count__h10599 + 4'd1 ;
  assign i__h16042 = temp_word_count__h10599 + 4'd2 ;
  assign i__h17508 = temp_word_count__h10599 + 4'd3 ;
  assign i__h18974 = temp_word_count__h10599 + 4'd4 ;
  assign i__h20440 = temp_word_count__h10599 + 4'd5 ;
  assign i__h21906 = temp_word_count__h10599 + 4'd6 ;
  assign i__h22969 = temp_word_count__h10599 + 4'd7 ;
  assign ma_get_input_val_EQ_0_206_AND_NOT_rg_count_wid_ETC___d1232 =
	     ma_get_input_val == 32'd0 &&
	     (rg_count_width != 4'd1 ||
	      !rg_counter_209_EQ_IF_rg_count_width_70_EQ_1_20_ETC___d1224) ||
	     ma_get_input_val != 32'd0 && rg_counter != 8'd0 ;
  assign rg_counter_209_EQ_IF_rg_count_width_70_EQ_1_20_ETC___d1224 =
	     rg_counter == y__h24268 ;
  ...
  assign x__h13835 = rg_zero_counter + 7'd1 ;
  assign x__h13919 = bs__h23661[i__h14561[2:0]] ;
  assign x__h15331 = rg_zero_counter + 7'd2 ;
  assign x__h15400 = bs__h23661[i__h16042[2:0]] ;
  assign x__h16797 = rg_zero_counter + 7'd3 ;
  assign x__h16866 = bs__h23661[i__h17508[2:0]] ;
  assign x__h18263 = rg_zero_counter + 7'd4 ;
  assign x__h18332 = bs__h23661[i__h18974[2:0]] ;
  assign x__h19729 = rg_zero_counter + 7'd5 ;
  assign x__h19798 = bs__h23661[i__h20440[2:0]] ;
  assign x__h21195 = rg_zero_counter + 7'd6 ;
  assign x__h21264 = bs__h23661[i__h21906[2:0]] ;
  assign x__h22639 = rg_zero_counter + 7'd7 ;
  assign x__h22708 = bs__h23661[i__h22969[2:0]] ;
  assign x__h24339 = rg_counter + 8'd1 ;
  assign x__h29077 =
	     (rg_word_counter == 5'd16) ?
	       y_avValue_snd_snd_fst__h29062 :
	       y_avValue_snd_snd_fst__h29063 ;
  ...
  assign y_avValue_snd_snd_fst__h29062 =
  ...
  assign y_avValue_snd_snd_fst__h29063 =
	     (rg_zero_counter == 7'd64) ? y_avValue_snd_fst__h29067 : 64'd0 ;
  always@(rg_count_width)
  begin
    case (rg_count_width)
      4'd1: temp__h24264 = 8'd1;
