...
class Testbench(object):
    ...
    @cocotb.coroutine
    def dut_input_drive(self,input_list):
        #print("asserting reset")
        self.dut.RST_N <= 0
        yield Timer(2)
        self.dut.RST_N <= 1
        #print("asserted reset")
        ...
        while n2 < len(input_list):
            if(self.dut.RDY_ma_get_inputs != 1):
                ...
                #print(" Compressed input : ",n2)
                yield self.input_drv.send(InputTransaction(self,1,compressed_input))
                yield self.input_drv.send(InputTransaction(self,0,0))
                ##Input Randomisation
        ...
        for delay in range(10):
            yield RisingEdge(self.dut.CLK)
        #print(self.expected_output.count)
        #print(self.expected_output)
        #print(self.got_output.count)
        #print(self.got_output)
