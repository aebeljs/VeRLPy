...
#    tb = TestBench(dut)
#
#    m0_coroutine = cocotb.fork(read_master_0_response(dut))
#    m1_coroutine = cocotb.fork(read_master_1_response(dut))
#
#    s0_coroutine = cocotb.fork(send_slave_0_response(dut))
#    s1_coroutine = cocotb.fork(send_slave_1_response(dut))
#    s2_coroutine = cocotb.fork(send_slave_2_response(dut))
#    s3_coroutine = cocotb.fork(send_slave_3_response(dut))
#    s4_coroutine = cocotb.fork(send_slave_4_response(dut))
#    s5_coroutine = cocotb.fork(send_slave_5_response(dut))
#    s6_coroutine = cocotb.fork(send_slave_6_response(dut))
#    s7_coroutine = cocotb.fork(send_slave_7_response(dut))
#    s8_coroutine = cocotb.fork(send_slave_8_response(dut))
#    s9_coroutine = cocotb.fork(send_slave_9_response(dut))
#
...
#            yield RisingEdge(dut.CLK)
#
#        m0 = random.randint(4096,40960)
#        m1 = random.randint(4096,40960)
#        min_addr = min(m0,m1)
#        max_addr = max(m0,m1)
#        print("TOP ITERATION : ",iter_1,min_addr,max_addr)
#
#        m0_array = np.zeros(10)
#        m1_array = np.zeros(10)
#        iter = 0
#
#        while(iter < 100):  
#            if(dut.RDY_m_i_wr_addr_0_enq != 1 or dut.RDY_m_i_wr_addr_1_enq != 1):
#                #print("Skipping the step",iter,m0_array,m1_array)
#                if(dut.RDY_m_i_wr_addr_0_enq != 1):
#                    #print("\t AXI read master 0 request waiting for ENQ RDY ")
#                    #yield RisingEdge(self.dut.RDY_m_i_wr_addr_0_enq)
#                    yield RisingEdge(dut.CLK)
#                if(dut.RDY_m_i_wr_addr_1_enq != 1):
#                    #print("\t AXI read master 1 request waiting for ENQ RDY ")
#                    #yield RisingEdge(self.dut.RDY_m_i_wr_addr_1_enq)
#                    yield RisingEdge(dut.CLK)
#            else:      
#                #array = [4096, 8192, 12288, 16384, 20480, 24576, 28672, 32768, 36864, 40960]
#                #array = [4096, 8192, 12288]
#                #m0_addr = random.choice(array)
#                #m1_addr = random.choice(array)
#
#                m0_addr = random.randint(min_addr,max_addr)
#                m1_addr = random.randint(min_addr,max_addr)
#
#
#                print("Driving Input",iter,int(m0_addr/4096)-1,int(m1_addr/4096)-1,m0_array,m1_array)
#
#                m0_array[int(m0_addr/4096)-1] = m0_array[int(m0_addr/4096)-1] + 1
#                m1_array[int(m1_addr/4096)-1] = m1_array[int(m1_addr/4096)-1] + 1
#
#                m0_addr = m0_addr << 29
#                m1_addr = m1_addr << 29
#
#                yield tb.master_input_drv.send(Master_Input_Transaction(tb,m0_addr,m1_addr,0,0,1,1,1,1))
#                yield tb.master_input_drv.send(Master_Input_Transaction(tb,0,0,0,0,0,0,0,0))
#                for delay in range(4):
#                    yield RisingEdge(dut.CLK)
#
#                iter = iter + 1
#
#        print("Slave count : ",iter_1,m0_array,m1_array)
#
#        for n in range(1000):
#            yield RisingEdge(dut.CLK)
#
...
#                #print("************************************************************************************")
#
#    #print("Slave count : ",m0_array,m1_array)
#
#    #for n in range(1000):
#    #    yield RisingEdge(dut.CLK)
#
